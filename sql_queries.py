...
CREATE TABLE IF NOT EXISTS songplays (songplay_id SERIAL PRIMARY KEY, start_time bigint, user_id int, level varchar, song_id text, artist_id text, session_id int, location text, user_agent text)
""")
